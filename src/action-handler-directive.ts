...
customElements.define('action-handler-southeastern-rail', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-southeastern-rail')) {
    return body.querySelector('action-handler-southeastern-rail') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-southeastern-rail');
